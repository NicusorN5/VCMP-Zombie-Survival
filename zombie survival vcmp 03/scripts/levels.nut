	...
	if(LOADINGMAP == true) return;
		...
		switch(mapSelect)
		{
			...
			case 1:
			{
				...
				LOADEDMAP.AirDropAngle = -3.03704
				break;
			}
			case 2:
			{
...
MAP_SUNSHINE <- Level("Sunshine Autos",Vector(-378.817, -587.702, 25.3209),50,Vector(-378.697, -597.882, 25.8263),Vector(-371.468, -515.602, 12.8085),Vector(-383.661, -516.205, 12.8039));
